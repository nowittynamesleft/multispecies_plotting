...
# Main()
def plot_diff(fn_1, fn_2, go_name_file, label_1, label_2, title_label):
    ...
    print('First three go names and go ids:')
    print(goterms[:3])
    print(gonames[:3])
    ...
    plt.suptitle('AUPR ' + title_label, fontsize=16)
...
if __name__ == "__main__":
    ...
    label_1 = sys.argv[4]
    label_2 = sys.argv[5]
    title_label = sys.argv[6]

    plot_diff(fn_1, fn_2, go_name_file, label_1, label_2, title_label)
